...
export function TaskList({ group, tasks, toggleModal, setNewTasks, index }) {
    ...
    return (
        <div>
            ...
            <Draggable draggableId={group.id} type="TYPE1" index={index} >
                {(provided) => (
                    <div
                    ...
                    >
                        <div className="task-list">
                            ...
                            <div className="task-title-row flex">
                                ...
                                <Droppable droppableId="boardCmpsOrder" type="colum">
                                    {(provided) => (

                                        <div ref={provided.innerRef}
                                            {...provided.droppableProps}
                                            className='drag-colums-container flex '

                                        >

                                            {board.cmpsOrder.map((cmp, index) => {
                                                return <div onClick={(ev) => { ev.stopPropagation() }}>
                                                    <Draggable key={cmp + index} draggableId={cmp + index} index={index} type="colum">
                                                        {(provided) => (
                                                            <div
                                                                ref={provided.innerRef}
                                                                {...provided.draggableProps}
                                                                {...provided.dragHandleProps}
                                                                className='drag-colum '
                                                            >
                                                                {getCmpElement(cmp)}
                                                            </div>
                                                        )}
