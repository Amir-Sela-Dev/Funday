    ...
    return <section className="kanban-task-info">
        ...
        <div className="kanban-task-actions">
            ...
            <div className="colume-row flex">
                ...
                <div className="colum-title flex align-center"> <Icon icon={PersonRound} iconLabel="my bolt svg icon" style={{ width: '22px', height: '22px' }} iconSize={17} ignoreFocusStyle className="task-option-icon board-icon" />
                    Person</div>
            ...
            <div className="colume-row flex">
                ...
                <div className="colum-title flex align-center"><Icon icon={Status} iconLabel="my bolt svg icon" style={{ width: '22px', height: '22px' }} iconSize={17} ignoreFocusStyle className="task-option-icon board-icon" /> Status</div>
            ...
            <div className="colume-row flex">
                ...
                <div className="colum-title flex align-center"><Icon icon={Calendar} iconLabel="my bolt svg icon" style={{ width: '22px', height: '22px' }} iconSize={17} ignoreFocusStyle className="task-option-icon board-icon" /> Date</div>
            ...
            <div className="colume-row flex">
                ...
                <div className="colum-title flex align-center"><Icon icon={Calendar} iconLabel="my bolt svg icon" style={{ width: '22px', height: '22px' }} iconSize={17} ignoreFocusStyle className="task-option-icon board-icon" /> Timeline</div>
